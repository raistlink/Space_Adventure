       ...
       (case (world-gamestate world)
         ...
         ((gamescreen)
              ...
              (begin (set! spawncount (+ spawncount spawntimer))
                     (let loop ((spawns spawner) (counter 0))
                       (if (eq? spawner counter)
                           '()
                           (begin (world-enemies-set! world (cons (make-enemy (exact->inexact (+ (random-integer 620) 320)) -10.0) (world-enemies world)))
          ...
          (cond ((< (world-score world) 100)(cairo_show_text cr "LEVEL 1"))
                 ...
                 ((and (< (world-score world) 600) (> (world-score world) 499)) (cairo_show_text cr "LEVEL 5"))
                 ((and (< (world-score world) 700) (> (world-score world) 599)) (cairo_show_text cr "LEVEL 6"))
                 ((and (< (world-score world) 800) (> (world-score world) 699)) (cairo_show_text cr "LEVEL 7"))
                 ((and (< (world-score world) 900) (> (world-score world) 799)) (cairo_show_text cr "LEVEL 8"))
