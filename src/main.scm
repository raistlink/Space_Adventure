                 ...
                 ((= key SDLK_SPACE)
                  (if (not (eq? (world-shipstate world) 'shooting))
                      (if (eq? (world-gamestate world) 'gamescreen)
                          (make-world (world-gamestate world) (world-position world) (world-elevation world) (world-positionstate world) (world-elevationstate world) (cons (make-shot (+ (world-position world) 17.5)  (world-elevation world)) (world-bullets world)) (world-enemies world) 'shooting (world-score world) (world-highscore world) (world-stars world))
                          world)
                      world)) 
                 ((= key SDLK_LEFT)
                  (if (eq? (world-gamestate world) 'gamescreen)
                      (make-world 'gamescreen (world-position world) (world-elevation world) 'left (world-elevationstate world) (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_RIGHT)
                  (if (eq? (world-gamestate world) 'gamescreen)
                      (make-world 'gamescreen (world-position world) (world-elevation world) 'right (world-elevationstate world) (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_UP)
                  (if (eq? (world-gamestate world) 'gamescreen)
                      (make-world 'gamescreen (world-position world) (world-elevation world) (world-positionstate world) 'up  (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_DOWN)
                  (if (eq? (world-gamestate world) 'gamescreen)
                      (make-world 'gamescreen (world-position world) (world-elevation world) (world-positionstate world) 'down (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 (else
