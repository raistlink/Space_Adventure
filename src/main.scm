...
(define-structure world gamestate position elevation positionstate elevationstate bullets enemies shipstate score highscore stars)
  ...
  (let loop ((rest enemylist))
    (unless (null? rest)
            (if (and (or (> (enemy-posx (car rest)) (world-position world)) (> (+ (enemy-posx (car rest)) 20) (world-position world)))
                     ...
                     (> (enemy-posy (car rest)) (- (world-elevation world) 20))
                     (< (enemy-posy (car rest)) (world-elevation world)))
                #t
                (loop (cdr rest))))))
  ...
  ((fusion:create-simple-gl-cairo '(width: 1280 height: 752))
           ...
           (cond ((= key SDLK_ESCAPE)
                 ...
                 ((= key SDLK_RETURN)
                  (if (eq? (world-gamestate world) 'splashscreen)
                      (make-world 'gamescreen 600. 650.0  'idle 'idle '() '() 'idle  0 (world-highscore world) (create-stars (world-stars world) 200))
                      (make-world 'splashscreen (world-position world) (world-elevation world) 'idle 'idle (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))))
                 ((= key SDLK_h)
                  (if (eq? (world-gamestate world) 'splashscreen)
                      (make-world 'highscores (world-position world) (world-elevation world) 'idle 'idle (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_SPACE)
                  (if (not (eq? (world-shipstate world) 'shooting))
                      (if (or (eq? (world-gamestate world) 'gamescreen) (eq? (world-gamestate world) 'boss-screen))
                          (make-world (world-gamestate world) (world-position world) (world-elevation world) (world-positionstate world) (world-elevationstate world)
                                      (cons (make-shot (+ (world-position world) 17.5)  (world-elevation world)) (world-bullets world)) (world-enemies world) 'shooting (world-score world) (world-highscore world) (world-stars world))
                          world)
                      world)) 
                 ((= key SDLK_LEFT)
                  (if (or (eq? (world-gamestate world) 'gamescreen) (eq? (world-gamestate world) 'boss-screen))
                      (make-world (world-gamestate world) (world-position world) (world-elevation world) 'left (world-elevationstate world) (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_RIGHT)
                  (if (or (eq? (world-gamestate world) 'gamescreen) (eq? (world-gamestate world) 'boss-screen))
                      (make-world (world-gamestate world) (world-position world) (world-elevation world) 'right (world-elevationstate world) (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_UP)
                  (if (or (eq? (world-gamestate world) 'gamescreen) (eq? (world-gamestate world) 'boss-screen))
                      (make-world (world-gamestate world) (world-position world) (world-elevation world) (world-positionstate world) 'up  (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_DOWN)
                  (if (or (eq? (world-gamestate world) 'gamescreen) (eq? (world-gamestate world) 'boss-screen))
                      (make-world (world-gamestate world) (world-position world) (world-elevation world) (world-positionstate world) 'down (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 (else
         ...
         (let* ((kevt (SDL_Event-key event))
           ...
           (cond ((= key SDLK_LEFT)
                  (if (eq? (world-positionstate world) 'left)
                      (make-world (world-gamestate world) (world-position world) (world-elevation world) 'idle (world-elevationstate world) (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_RIGHT)
                  (if (eq? (world-positionstate world) 'right)
                      ...
                      world))
                 ((= key SDLK_UP)
                  (if (eq? (world-elevationstate world) 'up)
                      (make-world (world-gamestate world) (world-position world) (world-elevation world) (world-positionstate world) 'idle (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_DOWN)
                  (if (eq? (world-elevationstate world) 'down)
                      (make-world (world-gamestate world) (world-position world) (world-elevation world) (world-positionstate world) 'idle (world-bullets world) (world-enemies world) (world-shipstate world) (world-score world) (world-highscore world) (world-stars world))
                      world))
                 ((= key SDLK_SPACE)
                  (make-world (world-gamestate world) (world-position world) (world-elevation world) (world-positionstate world) (world-elevationstate world) (world-bullets world) (world-enemies world) 'idle (world-score world) (world-highscore world) (world-stars world)))
                 (else
                  world))))
        (else
         world))))
   ...
   (let ((spawntimer 1000) (spawncount 0) (spawner 1) (last-time 0) (delta-time 0)) 
     (lambda (cr time world)
       (let* ((level-number (if (< ( world-score world) 1000) (floor (+ (/ (world-score world) 100) 1)) 10)) (level-contents (cdr (assq level-number game-contents))))
         ...
         (case (world-gamestate world)
           ...
           ((gamescreen)
            ...
            ;; TO DO - Codigo para el boss level
            
            ;; (if (and (> (world-score world) 499) (< (world-score world) 511))
            ;;     (begin (world-position-set! world 40.0)
             ;;            (world-elevation-set! world 400.0)
            ;;            (world-gamestate-set! world 'boss-screen)))
            (if (eq? (world-positionstate world) 'left)
            ...
            (if (eq? (world-elevationstate world) 'up)
                (if (> (world-elevation world) 10.0)
                    (world-elevation-set! world (- (world-elevation world) (* 0.5 delta-time)))
                    (world-elevation-set! world 10.0)))
            (if (eq? (world-elevationstate world) 'down)
                (if (< (world-elevation world) 702.0)
                    (world-elevation-set! world (+ (world-elevation world) (* 0.5 delta-time)))
                    (world-elevation-set! world 702.0)))
            ...
            (cairo_rectangle cr (world-position world) (world-elevation world) 40.0 40.0)
            (cairo_fill cr))
           ...
           ;;  (cairo_fill cr)
           ;;  (cairo_set_source_rgba cr 0.0 0.0 0.0 1.0)
           ;;  (cairo_rectangle cr 10.0 10.0 1260.0 732.0)
           ;;  (cairo_fill cr)
           ;;  (cairo_set_source_rgba cr 1.0 0.0 0.0 0.8)
           ;;  (cairo_rectangle cr (world-position world) (world-elevation world) 40.0 40.0)
           ;;  (cairo_fill cr)
           ;;  (if (eq? (world-positionstate world) 'left)
           ;;      (if (> (world-position world) 10.0)
           ;;          (world-position-set! world (- (world-position world) (* 0.5 delta-time)))
           ;;          (world-position-set! world 10.0)))
           ;;  (if (eq? (world-positionstate world) 'right)
           ;;      (if (< (world-position world) 1230.0)
           ;;          (world-position-set! world (+ (world-position world) (* 0.5 delta-time)))
           ;;          (world-position-set! world 1230.0)))
           ;;  (if (eq? (world-elevationstate world) 'up)
           ;;      (if (> (world-elevation world) 10.0)
           ;;          (world-elevation-set! world (- (world-elevation world) (* 0.5 delta-time)))
           ;;          (world-elevation-set! world 10.0)))
           ...
           ;;          (world-elevation-set! world (+ (world-elevation world) (* 0.5 delta-time)))
           ;;          (world-elevation-set! world 702.0)))
           ;;  (world-bullets-set! world (remove (lambda (shot) (> (shot-posx shot) 1300)) (world-bullets world)))
           ;;  (let loop ((rest (world-bullets world)))
           ;;    (if (null? rest) 
           ;;        '()
           ;;        (begin (shot-posx-set! (car rest) (+ (shot-posx (car rest)) delta-time))
           ;;               (cairo_set_source_rgba cr 1.0 1.0 0.0 1.0)
           ;;               (cairo_rectangle cr (shot-posx (car rest)) (shot-posy (car rest)) 10.0 5.0)
           ;;               (cairo_fill cr)
           ;;               (loop (cdr rest))))))
